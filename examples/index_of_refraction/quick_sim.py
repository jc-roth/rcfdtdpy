...
if plot_data:
    ...
    #ax_n.set_ylim(3.10, 3.11)
    ax_n.legend((n1_line, kappa1_line), ('$n$', '$\kappa$'), bbox_to_anchor=(0., 1.02, 1., .102), loc=3, ncol=2, mode='expand', borderaxespad=0)
    # Final setup
    ax_time.set_title(r'RC-FDTD Simulation: $\epsilon_\infty=%0.2f$, $A=%0.2f$, $\gamma=%0.2f$, $\nu=%0.2f$, L=$%0.2f$um, THz pulse' % (inf_perm, a, gamma, nu, m_len_val))
    ax_p.set_xlim(0,10)
    plt.tight_layout()
    # Show figure
    plt.show()