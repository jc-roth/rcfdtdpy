...
class TwoStateMaterial(Material):
    ...
    The fraction of oscillators in each state is defined as a function of time passed to the material. This Material is
    designed to simulate the dynamic material defined by Beard and Schmuttenmaer www.doi.org/10.1063/1.1338526
